...
- Storybook (or Ladle) deployed for review
...
- `pos-desktop`: Electron loading pos-web, auto-update wiring, prints a **test receipt to a real/virtual ESC/POS printer** (spike de-risks hardware early)
